...
Original file is located at
    https://colab.research.google.com/drive/1iRTQpIB3r2DTEPcgAuLVbOPVgkvxcA-K
...
checkpoint = ModelCheckpoint("model.h5",monitor="val_accuracy", save_best_only=True, model="auto", verbose=1)
earlystop = EarlyStopping("val_accuracy", patience=5, mode="auto", verbose=1)
...
test_img1 = cv2.imread("/content/Test-Data/pituitary_tumor/0.jpg")
